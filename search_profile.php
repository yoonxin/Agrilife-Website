...
<body>
    <nav class="navbar">
        <div class="navbar_left">
            ...
            <form id="searchForm" action="search_profile.php" method="get" onsubmit="submitForm(event)">
...
<div class="main-content">
            ...
            include("conn.php");
            $search = $_GET['search'];
            $sql = "SELECT * FROM posts WHERE user_email='$user_email' AND post LIKE '%".$search."%' ORDER BY post_date DESC";
