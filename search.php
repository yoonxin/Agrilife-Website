...
<body>
    <nav class="navbar">
         ...
         <div class="navbar-center">
            <ul>
                <li><a href="main_page.php" class="active_link"><img src="photos/home.png"><span>Home</span></a></li>
    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="create-post">
                <form action="insert.php" method="post" enctype="multipart/form-data">
                    <div class="create-post-input">
                        <?php echo "<img src=$user_pic>"?>
                        <textarea name="post" textarea rows="2" placeholder="Write a post"></textarea>
                        <input id="user_id" name="user_id" value="1">
                    </div>
                    <div class="create-post-links">
                        <li><img src="images/post_image.webp"><input type="file" id="images" name="images" class="images"></li>
                        <li><input id="post-button" type="submit" value="Post" name="submit"></li>
                    </div>
                </form>
            ...
            include("conn.php");
            $search = $_GET['search'];
            $sql = "SELECT * FROM posts WHERE post LIKE '%".$search."%' OR user_name LIKE '%".$search."%' ORDER BY post_date DESC";
        ...
        <div class="right-sidebar">
            <div class="sidebar-news">
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    // Display each record
                    echo "<a href=news_pages.php>$row[news_title]</a>";
